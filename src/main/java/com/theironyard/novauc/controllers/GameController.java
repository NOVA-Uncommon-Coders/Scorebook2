  ...
  @RequestMapping(path = "/user", method = RequestMethod.GET)
   public String user(Model model, HttpSession session){
    ...
    public String addUser(Model model, HttpSession session, String userName, String passWord){
     ...
     public String save(Model model, HttpSession session, String updatedCanvas) throws IOException {
        ...
        PrintWriter outputFile = new PrintWriter("/Users/mfahrner/Downloads/Scorebook-master/public/stats.html");
